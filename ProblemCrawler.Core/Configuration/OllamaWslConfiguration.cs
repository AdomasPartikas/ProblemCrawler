...
namespace ProblemCrawler.Core.Configuration
{
        ...
        string BaseUrl)
    {
        ...
        {
            var modelsRaw = cfg["LLMAnalysis:Ollama:Model"] ?? throw new InvalidOperationException("LLMAnalysis:Ollama:Model is required");
            ...
            return new OllamaWslConfiguration(
                Models: modelsRaw.Split(' ', StringSplitOptions.RemoveEmptyEntries),
